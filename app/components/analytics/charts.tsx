    ...
    <ResponsiveContainer width="100%" height={260}>
      <LineChart data={data}>
        ...
        <Tooltip
          ...
          labelStyle={{ color: "#12141A" }}
        />
        <Line type="monotone" dataKey="impressions" stroke="#3B66F6" strokeWidth={2} dot={false} name="Afișări" />
        <Line type="monotone" dataKey="engagement" stroke="#16A34A" strokeWidth={2} dot={false} name="Interacțiuni" />
      </LineChart>
    </ResponsiveContainer>
  );
}
