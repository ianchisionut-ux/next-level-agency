export function NavLogoIcon({ className = "h-9 w-9" }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="40" height="40" rx="10" fill="url(#nl-nav-grad)" />
      <path d="M11 28V12h3.2L23 24.2V12h3v16h-3.2L14 15.8V28h-3z" fill="white" />
      <defs>
        <linearGradient id="nl-nav-grad" x1="0" y1="0" x2="40" y2="40" gradientUnits="userSpaceOnUse">
...
export function BrandLogo({ className = "h-9" }: { className?: string }) {
  // Logo complet (marcă + wordmark), fundal transparent — afișat direct,
  // fără chip alb în spate.
  return (
    // eslint-disable-next-line @next/next/no-img-element
    <img
      src="/brand/logo-full.png"
      alt="Next Level Advertising Agency"
...
export function BrandMark({ className = "h-16 w-16" }: { className?: string }) {
  // Doar marca (săgeata/M), fără text - pentru favicon-like spots și hero.
  return (
    // eslint-disable-next-line @next/next/no-img-element
    <img
...
// --- Iconițe rețele sociale ---

export function IconFacebook({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} xmlns="http://www.w3.org/2000/svg">
      <path d="M13.5 21v-7.6h2.6l.4-3h-3v-1.9c0-.87.24-1.46 1.5-1.46h1.6V4.3c-.28-.04-1.23-.12-2.34-.12-2.32 0-3.9 1.4-3.9 4V10.4H9.7v3h2.06V21h1.74z" />
    </svg>
  );
}
...
export function IconTiktok({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} xmlns="http://www.w3.org/2000/svg">
      <path d="M16.5 3c.3 1.9 1.5 3.3 3.5 3.6v2.6c-1.3.1-2.5-.3-3.5-1v6.4c0 3-2.2 5.1-5 5.1-2.7 0-5-2.1-5-5 0-2.9 2.3-5 5-5 .3 0 .6 0 .9.1v2.7a2.3 2.3 0 0 0-.9-.2c-1.3 0-2.3 1-2.3 2.4 0 1.3 1 2.3 2.3 2.3 1.4 0 2.4-1.1 2.4-2.5V3h2.6z" />
    </svg>
  );
}
...
// --- Iconițe pentru secțiunea "Procesul nostru" ---

export function IconDiscovery({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
...
export function IconStrategy({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      <path d="M6 4v16" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M6 5h10l-2.5 3L16 11H6" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
    </svg>
  );
}

export function IconExecution({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      <path
        d="M12 3c3 1.5 4.5 4.5 4.5 8 0 2-.5 3.5-1 4.5l-3.5 4-3.5-4c-.5-1-1-2.5-1-4.5 0-3.5 1.5-6.5 4.5-8Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
      <circle cx="12" cy="10" r="1.6" stroke="currentColor" strokeWidth="1.4" />
      <path d="M8.5 17 6 20M15.5 17 18 20" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}

export function IconOptimization({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      <path d="M4 15a8 8 0 0 1 16 0" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M12 15 15.5 9.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <circle cx="12" cy="15" r="1.3" fill="currentColor" />
    </svg>
  );
}

export function IconGrowth({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      <path d="M4 19h16" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M6 19v-4M11 19v-7M16 19v-3" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <path d="m5 10 4.5-4.5L12 8l6-6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14 2h4v4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
