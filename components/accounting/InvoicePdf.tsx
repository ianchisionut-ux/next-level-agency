...
const styles = StyleSheet.create({
  ...
  invoiceLabel: { fontSize: 8, letterSpacing: 1.2, color: "#c8e2ff" },
  invoiceNumber: { fontFamily: "Helvetica-Bold", fontSize: 17, marginTop: 3 },
  invoiceMeta: { marginTop: 8, fontSize: 8, lineHeight: 1.5, color: "#edf6ff" },
  ...
  badge: { alignSelf: "flex-start", marginTop: 5, paddingVertical: 3, paddingHorizontal: 6, borderRadius: 8, backgroundColor: "#e3f1ff", color: BLUE, fontFamily: "Helvetica-Bold", fontSize: 6.5 },
});
...
export function InvoicePdf({ invoice, items, client, company }: { invoice: Invoice; items: InvoiceItem[]; client: Client; company: Company }) {
  ...
  return <Document><Page size="A4" style={styles.page}>
    ...
    <View style={styles.header}>
      <View style={styles.identity}><Image src={LOGO} style={styles.logo}/><View><Text style={styles.companyName}>{companyPdf.name}</Text><Text style={styles.companyTagline}>Marketing. Automation. Results.</Text><Text style={styles.badge}>DOCUMENT FISCAL</Text></View></View>
