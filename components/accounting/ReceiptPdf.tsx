...
const NAVY="#001a3d", BLUE="#087ff5", SKY="#edf6ff", LINE="#cbdcf1", MUTED="#64748b";
const LOGO=ACCOUNTING_LOGO_DATA_URI;
const styles=StyleSheet.create({
 page:{padding:38,fontSize:9,fontFamily:"Helvetica",color:"#1d3552"},line:{height:5,backgroundColor:BLUE,borderRadius:3,marginBottom:16},
 header:{flexDirection:"row",justifyContent:"space-between",alignItems:"center"},brand:{flexDirection:"row",alignItems:"center"},logo:{width:52,height:52,objectFit:"contain",marginRight:11},
 ...
 docLabel:{fontSize:7,letterSpacing:1,color:"#c8e2ff"},docNo:{fontFamily:"Helvetica-Bold",fontSize:16,marginTop:3},docDate:{fontSize:8,marginTop:7,color:"#edf6ff"},
 ...
 amountLabel:{fontSize:8,color:"#c8e2ff"},amountValue:{fontFamily:"Helvetica-Bold",fontSize:17},words:{marginTop:10,backgroundColor:SKY,borderRadius:7,padding:11,fontSize:8,lineHeight:1.5},
