...
import { BarChart3, BookOpenCheck, Building2, FilePlus2, FileText, LayoutDashboard, Package, Users, UserRoundCog } from 'lucide-react'
...
const items = [
  ...
  { href: '/dashboard/contabilitate/ref', label: 'Registru fiscal', icon: BookOpenCheck },
